...
class MoveDrone:
    def __init__(self):
        ...
        self.z_angular_pid = PID(0.2, 0.01, 0.04, 3.0, -3.0, 1.0, -1.0, 0.1) # with vision
    ...
    def move_drone(self):
        ...
        while not rospy.is_shutdown():
            ...
            y_error = -current_gimbal_pitch + 5          
            ...
            # if abs(y_error) > 3:
            y_output = self.vel_z_pid.update(y_error*0.12)
            # else:
            #     y_output = 0.0
            ...
            angle_pitch_deg = current_gimbal_pitch-2 # -: down , + : up
            # m/s
