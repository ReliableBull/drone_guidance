...
sub_image = rospy.Subscriber("/iris_depth_camera0/camera/rgb/image_raw", Image, image_callback)
...
pose_sub = rospy.Subscriber('/uav0/mavros/local_position/pose', PoseStamped, pose_callback)
