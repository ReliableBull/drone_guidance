...
class MoveDrone:
    def __init__(self):
        ...
        self.vel_y_pid = PID(0.15, 0.01, 0.01, 1.0, -1.0, 1.0, -1.0, 0.1)
        ...
        self.z_angular_pid = PID(0.05, 0.01, 0.01, 3.0, -3.0, 1.0, -1.0, 0.1) # with vision
        ...
        self.detect_flag = 0
        # self.keyThread = threading.Thread(target=self.onKeyInput, args=(self.keyQueue,))
    ...
    def center_callback(self, msg):
        ...
        target_center_x = msg.x
        target_center_y = msg.y

        self.detect_flag = msg.z

        self.x_error =  image_width/2 - target_center_x 
        self.y_error =  target_center_y - image_height/2  
    ...
    def move_drone(self):
        ...
        while not rospy.is_shutdown():
            ...
            # if abs(yaw_error) > 10:
            yaw_output = -self.z_angular_pid.update(self.x_error*0.1)


            y_output = self.vel_y_pid.update(self.y_error*0.1)
            ...
            if self.mission_flag == 0 and self.detect_flag == 1:
                self.mission_flag = 1
